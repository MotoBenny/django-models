...
class SnackTests(TestCase):
    ...
    def create_snack_to_test():
        ...
        Snack.objects.create(name="Testcase", purchaser=purchaser, description="Not actually a snack, just a test.")
    ...
    def test_list_page_context(self):
        ...
        self.assertEqual(snacks[0].description, "Not actually a snack, just a test.")
